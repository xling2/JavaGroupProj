...
public class student_quiz_reportController implements Initializable {
    ...
    private void export(ActionEvent event) {
        ...
        String documentName = goPage.student.id + df.format(goPage.quizOfCurrentCheck.finishDate)
                + "_quiz_report" + ".PDF";
        ...
        if (exportPDF.exists()) {
            ...
            try {
                ...
                PDFGeneral.addContentLine(document,
                        String.format("%s%s", PDFGeneral.getFormatString("StudentID:", 30), goPage.student.id));
                PDFGeneral.addContentLine(document,
                        String.format("%s%s", PDFGeneral.getFormatString("StudentName:", 26), goPage.student.name));
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        tips.setVisible(false);
        successedTips.setVisible(false);
        name.setText(goPage.quizOfCurrentCheck.student.name);
        SimpleDateFormat df = new SimpleDateFormat("yyyy-MM-dd hh:mm");
