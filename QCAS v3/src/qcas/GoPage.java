...
public class GoPage {
    ...
    public int[] geteasyAverageScoreOfThreeLastTime() {
        return communicateWithServe.geteasyAverageScoreOfThreeLastTime();
    }

    public int[] getMediumAverageScoreOfThreeLastTime() {
        return communicateWithServe.getMediumAverageScoreOfThreeLastTime();
    }

    public int[] getHardAverageScoreOfThreeLastTime() {
        return communicateWithServe.getHardAverageScoreOfThreeLastTime();
    }
